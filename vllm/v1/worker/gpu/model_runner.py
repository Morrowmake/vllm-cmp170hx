...
class GPUModelRunner(LoRAModelRunnerMixin):
    ...
    def initialize_kv_cache(
        ...
        for kv_cache_group in kv_cache_config.kv_cache_groups:
            ...
            # Only DCP-sharded groups get localized slot mappings. The helper
            # returns the process DCP size for full-attention/MLA specs (which
            # includes the pooled DSA indexer cache) and 1 for everything else
            # (Mamba/KDA state, the kpool tail scratch's SlidingWindow-derived
            # KpoolTailSpec).
            cp_enabled.append(
